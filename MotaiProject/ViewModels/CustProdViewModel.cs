...
{
    public class CustProdViewModel
    {
        ...
        public int pQty
        {
            get { return (int)this.Product.tWarehouses.FirstOrDefault(w => w.wProductId.Equals(pNumber)).wQuantity; }
            set { Product.tWarehouses.FirstOrDefault(w => w.wProductId.Equals(pNumber)).wQuantity = value; }
        }
    }
}